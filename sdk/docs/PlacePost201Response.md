...
```typescript
import type { PlacePost201Response } from ''
...
} satisfies PlacePost201Response
...
const exampleParsed = JSON.parse(exampleJSON) as PlacePost201Response
