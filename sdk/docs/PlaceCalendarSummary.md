...
```typescript
import type { PlaceCalendarSummary } from '@steinv/uitpas-sdk'
...
const example = {
  ...
  "de": null,
  "en": null,
} satisfies PlaceCalendarSummary
...
const exampleParsed = JSON.parse(exampleJSON) as PlaceCalendarSummary
