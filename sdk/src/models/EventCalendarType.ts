...
export function instanceOfEventCalendarType(value: any): boolean {
    for (const key in EventCalendarType) {
        if (Object.prototype.hasOwnProperty.call(EventCalendarType, key)) {
            if (EventCalendarType[key as keyof typeof EventCalendarType] === value) {
                return true;
            }
        }
    }
...
export function EventCalendarTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventCalendarType {
    return json as EventCalendarType;
}
...
export function EventCalendarTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): EventCalendarType {
    return value as EventCalendarType;
}
